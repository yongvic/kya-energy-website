      ...
      <div
        ...
        <div className="chat-header">
          <div className="justify-self-start">
            <Link
              href="https://api.whatsapp.com/send?phone=22898263330"
              target="_blank"
              className="text-white font-bold text-[10px] flex items-center justify-center flex-col-reverse text-center">
          ...
          <div id="historique">
            <div>
              <p className="text-center font-bold">
                {t("comment puis-je vous servir")}
              </p>
              <div className="grid grid-cols-2 gap-2 mt-2">
                {[
                  t("questions.c'est quoi l'énergie solaire"),
                  t("questions.quels produits proposez vous"),
                  t("questions.votre localisation"),
                  t("questions.cout d'un pack solaire"),
                ].map((value, index) => (
                  <div
                    onClick={() => {
                    ...
                    style={{
                      background:
                        "linear-gradient(135deg, #1ca18c 0%, #059669 100%)",
                    }}
