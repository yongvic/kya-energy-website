    ...
    <div ref={founderScope} id="dg" className="container mx-auto px-4 my-32 flex flex-col lg:flex-row gap-8 items-center overflow-hidden">
      ...
      <div className="founder-image opacity-0 w-max relative">
        <div className="w-max rounded-xl overflow-hidden shadow-xl">
          <Image width={296} height={361} src={`/team/fondateur.png`} alt={t("nom")} className="object-cover" />
        </div>
      ...
      <div className="flex flex-col gap-8">
        <h2 className="founder-content opacity-0 font-bold text-4xl text-center lg:text-left">{t("nom")}</h2>
        <p className="founder-content opacity-0 text-kya-green text-2xl text-center lg:text-left font-medium">{t("fonction")}</p>
